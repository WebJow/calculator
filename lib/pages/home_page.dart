...
class _MyHomePageState extends State<MyHomePage> {
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  new Expanded(
                    child: new Column(
                      children: <Widget>[
                        Expanded(flex: 1, child: buildButton(text: '*', lineHeight: 1.7, textColor: Colors.white, bgColor: Colors.grey[700], padding: EdgeInsets.only(top: 12, bottom: 12, right: 10, left: 5))),
                        Expanded(flex: 2, child: buildButton(text: 'Next', lineHeight: 1.0, fontSize: 18.0, textColor: Colors.white, bgColor: Colors.grey[700], padding: EdgeInsets.only(top: 12, bottom: 12, right: 10, left: 5))),
                        Expanded(flex: 1, child: buildButton(text: '000', lineHeight: 1.2, fontSize: 19.0, textColor: Colors.white, bgColor: Colors.grey[700], padding: EdgeInsets.only(top: 12, bottom: 12, right: 10, left: 5))),
  ...
  Container displayArea(BuildContext context) {
    return new Container(
      ...
      // height: (MediaQuery.of(context).size.height * part),
      width: MediaQuery.of(context).size.width,
      color: Colors.white,
      child: SafeArea(
        child: new Row(
  ...
  Widget buildButton({text, double fontSize: 21.0, EdgeInsetsGeometry padding: const EdgeInsets.all(15), bgColor: Colors.red, textColor: Colors.black, double lineHeight: 1.0}) {
    return Container(
      padding: padding,
      child: Material(
        color: bgColor,
